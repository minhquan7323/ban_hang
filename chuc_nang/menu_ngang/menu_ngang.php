			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<?php 
					...
					while ($tv_2 = $tv_1->fetch_assoc()) {
						...
						echo "<li class='nav-item top_nav'>
								<a class='nav-link' href='$link_menu'style='color:rgb(52, 100, 125);'>" . $tv_2['ten'] . "</a>
							</li>
						";
					}
					echo'</ul>';
				...
				<?php include("chuc_nang/nguoi_dung/vung_nguoi_dung.php");?>
			</div>
		</div>
	</nav>
	<br>
